...
#define N(X) bthbio::chain::string_to_name(#X)
...
namespace fc {
  class variant;
  void to_variant(const bthbio::chain::name& c, fc::variant& v);
  void from_variant(const fc::variant& v, bthbio::chain::name& check);
} // fc


FC_REFLECT( bthbio::chain::name, (value) )
