 ...
 */
#include <BithumbCoinio/wallet_api_plugin/wallet_api_plugin.hpp>
...
namespace BithumbCoinio { namespace detail {
  struct wallet_api_plugin_empty {};
}}

FC_REFLECT(BithumbCoinio::detail::wallet_api_plugin_empty, );
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     BithumbCoinio::detail::wallet_api_plugin_empty result;
