 ...
 */
#include <bthbio/net_api_plugin/net_api_plugin.hpp>
...
namespace bthbio { namespace detail {
  struct net_api_plugin_empty {};
}}

FC_REFLECT(bthbio::detail::net_api_plugin_empty, );
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     bthbio::detail::net_api_plugin_empty result;
