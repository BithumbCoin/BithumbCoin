...
public:
   ...
   bool import_key(string wif_key)
   {
      ...
      BithumbCoinio::chain::public_key_type wif_pub_key = priv.get_public_key();
...
} BithumbCoin_RETHROW_EXCEPTIONS(chain::wallet_invalid_password_exception,
